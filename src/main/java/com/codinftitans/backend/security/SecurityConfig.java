    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests( auth -> auth
                        ...
                        .requestMatchers("/order/all").permitAll()
                        .requestMatchers("/stat/client").permitAll()
                        .requestMatchers("/sum/chocolate").permitAll()
                        .requestMatchers("/stat/category").permitAll()
                        .requestMatchers("/stat/origin").permitAll()
                        .requestMatchers("/mail").permitAll()
                        .requestMatchers("/product/far").permitAll()
                        .requestMatchers("/qualityPrice/ratio").permitAll()
                        .requestMatchers("/distance/price").permitAll()
